...
url=http://cerner.github.io/beadledom/3.3-beta3
url_base=${url%\/*}
...
cat <<EOF > index.html
  ...
  <head>
    ...
    <meta http-equiv="refresh" content="5; url="http://cerner.github.io/beadledom/3.3-beta3/docs"">
    <script type="text/javascript">
        window.location.replace("http://cerner.github.io/beadledom/3.3-beta3/docs");
    </script>
  </head>
  <body>
    $(printf "%s\n" "${directories[@]}")
