  ...
  describe("BuiltGenericResponse") {
    describe("#create") {
      it("creates a new instance of BuiltGenericResponse") {
        ...
        val response = BuiltGenericResponse.create("Hello World", rawResponse)

        response mustBe a[BuiltGenericResponse[_]]
      }
    }
    ...
    describe("#body") {
      ...
      it("returns null when no body is present") {
        val rawResponse = mock[Response]
        val response: GenericResponse[String] = BuiltGenericResponse.create(null, rawResponse)
    ...
    describe("#errorBody") {
      it("returns the error response body") {
        ...
        val response = BuiltGenericResponse.create(null, rawResponse)
    ...
    describe("#getEntityClass") {
      ...
      it("returns null when no body is present") {
        val rawResponse = mock[Response]
        val response: BuiltGenericResponse[String] = BuiltGenericResponse
